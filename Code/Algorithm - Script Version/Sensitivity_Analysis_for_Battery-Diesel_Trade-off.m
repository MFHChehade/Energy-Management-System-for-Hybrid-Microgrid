...
diesel_array=[];
battery_array=0:10:8000;
for E_bat_nominal_Ah=battery_array
V_bat_nominal=12; 
...
total_pv+total_battery+total_diesel+total_grid;
...
%display(percentage_diesel);
diesel_array=[diesel_array,percentage_diesel];

end
plot(battery_array,diesel_array)

title('Diesel contribution with Battery Size')
xlabel('Battery Size (Ah)')
ylabel('% Diesel Contribution')